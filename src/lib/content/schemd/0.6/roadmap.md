...
bounded; and scalar/bus coercion is rejected instead of guessed. See [Limitations](/docs/0.6/overview#limitations)
and [Resource budgets](/docs/0.6/limits) before treating untrusted source as a server workload.
