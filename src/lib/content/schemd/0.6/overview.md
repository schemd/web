<!-- schemd-doc: id=overview; label=Quickstart; title=Start with schemd 0.6; summary=Compile multi-domain engineering diagrams into deterministic accessible SVG, and inspect the circuit behind them.; category=Get started; order=10 -->
...
<!-- schemd-section: id=migrate; eyebrow=02 / Migration; title=Move to 0.6 deliberately; example-title=Canonical gate terminals; example-summary=A gate wired through the `out` alias still emits `out1`. -->
