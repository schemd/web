...
These items affect correctness. They come first.
...
These items turn valid output into dependable, professional output.
...
These items expand the language or reduce repeated work. Correctness work can change their final shape.
...
**Lifecycle:** this is an active queue, not a changelog. The PR that finishes an item removes it here and from the [GitHub roadmap](https://github.com/Sirneij/schemd/blob/main/ROADMAP.md). The issue, merged PR, and Git history keep the record.
